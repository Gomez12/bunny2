...
| done          | docs/dev/plans/phase-01-system-foundation.md    |             8h | Phase 1.5: HTTP API + Vite/React/Tailwind/shadcn frontend + i18n + status + chat round-trip                                                      |
| needs-testing | docs/dev/plans/phase-01-system-foundation.md    |             8h | Phase 1.6: Electron wrapper + Bun sidecar + portable per-OS packaging (macOS verified end-to-end; Linux/Windows pending CI matrix per phase 1.7) |
